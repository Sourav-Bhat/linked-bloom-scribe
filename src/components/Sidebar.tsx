...
const menuItems = [
  ...
  { name: "Generator", icon: Edit, path: "/generator" },
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200 hidden md:block">
      ...
      <div className="mt-auto pt-8 px-4 absolute bottom-6 left-0 right-0">
        <div className="border-t pt-4">
          <Link 
            to="#"
            className="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-linkedin-lightblue hover:text-linkedin-blue"
          >
